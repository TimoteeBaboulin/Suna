...
public struct CharacterDebugInputComponent : IInputComponentData
{
...
public partial class DebugInputSystem : SystemBase
{
    ...
    {
        RequireForUpdate<CharacterDebugInputComponent>();
    }

    protected override void OnUpdate()
    {
        foreach (var characterDebugInput in SystemAPI
            .Query<RefRW<CharacterDebugInputComponent>>()
...
public partial struct CharacterInputDebugSystem : ISystem
{
    ...
    {
        state.RequireForUpdate<CharacterDebugInputComponent>();
    }

    public void OnUpdate(ref SystemState state)
    {
        foreach (var (characterDebugInput, currentHeath) in SystemAPI
            .Query<RefRO<CharacterDebugInputComponent>, RefRW<CurrentHealthComponent>>()
